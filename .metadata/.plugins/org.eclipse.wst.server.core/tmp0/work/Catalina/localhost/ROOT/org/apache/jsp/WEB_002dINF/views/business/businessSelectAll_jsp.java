 ...
 * Generated at: 2023-08-02 07:39:22 UTC
...
public final class businessSelectAll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   GtBusinessVO _buvo = (GtBusinessVO)obj1;
	...
	List<GtProjectVO> aListPR = (List<GtProjectVO>) obj2;
      ...
      out.write("            \r\n");
      out.write("            keyword = \"");
      out.print( _buvo.getKeyword());
      out.write("\";\r\n");
      out.write("            searchfilter = \"");
      out.print( _buvo.getSearchfilter());
      out.write("\";\r\n");
      out.write("      \r\n");
      out.write("            \r\n");
      out.write("            if(searchfilter == null || searchfilter == \"\" || searchfilter == \"null\"){\r\n");
      out.write("               $(\"#searchfilter\").val(\"-\").prop(\"selected\",true);\r\n");
      out.write("      \r\n");
      out.write("            }else{\r\n");
      out.write("               $(\"#searchfilter\").val(\"");
      out.print( _buvo.getSearchfilter());
      out.write("\").prop(\"selected\",true);\r\n");
      out.write("               \r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            if(keyword == null || keyword == \"\" || keyword == \"null\"){\r\n");
      ...
      out.write("               \r\n");
      out.write("               $(\"#business_selectall\").attr({\r\n");
      out.write("                  \"action\":\"gtBusinessSelectAll.gos\",\r\n");
      ...
      out.write("\r\n");
      out.write("      <br>\r\n");
      out.write("      <span style=\"margin-left:50px; font-size:20px; line-height:1; color: #337ab7;\"><strong>출장 전체 조회</strong></span>\r\n");
      out.write("      <div class=\"alert\" style=\"background-color: whitesmoke; height: auto\">\r\n");
      out.write("      </div>\r\n");
      out.write("         <span style=\"color: #337ab7; line-height:1; margin-left:1377px;\">HOME</span><span style=\"line-height:1;\">&nbsp;/ 출장 전체 조회</span>\r\n");
      out.write("          <table style=\"margin-left:auto; margin-right:auto; border-top:2px solid #1C1C1C; background-color : white; border-radius: 3px; width:1400px;\">\r\n");
      out.write("         <tr>\r\n");
      out.write("            <th colspan=\"7\" style=\"text-align:left;\"><img src=\"/resources/goats_icon/working_from_home.png\" width=\"15\" height=\"15\" style=\"position: relative; top:2px;\">출장 전체 조회</th>\r\n");
      out.write("         </tr>\r\n");
      out.write("         <tr>\r\n");
      out.write("         <td colspan=\"7\">\r\n");
      out.write("            <table style=\"width:100%\" class=Va_Table_S>\r\n");
      out.write("               <tr style=\"text-align:left;\">\r\n");
      out.write("                  <th style=\"width:5%; text-align:center;\">순서</th>\r\n");
      out.write("                  <th style=\"width:15%; text-align:center;\">작성자</th>\r\n");
      out.write("                  <th style=\"width:15%; text-align:center;\">프로젝트명</th>\r\n");
      out.write("                  <th style=\"width:15%; text-align:center;\">출장명</th>\r\n");
      out.write("                  <th style=\"width:15%; text-align:center;\">시작일시</th>\r\n");
      out.write("                  <th style=\"width:15%; text-align:center;\">종료일시</th>\r\n");
      out.write("               </tr>\r\n");
      out.write("                         ");
 for (int i = 0; i < aList.size(); i++){
      ...
      out.write("</td>\r\n");
      out.write("                  <td>");
      out.print(aList.get(i).getWriter());
      out.write("</td>\r\n");
      out.write("                  <td>");
      out.print(aListPR.get(i).getGpname());
      out.write("</td>\r\n");
      out.write("                  <td>");
      out.print(aList.get(i).getGbtname());
      out.write("</td>\r\n");
      out.write("                  <td style=\"text-align:center;\">");
      out.print(aList.get(i).getGbtstart());
      out.write("</td>\r\n");
      out.write("                  <td style=\"text-align:center;\">");
      out.print(aList.get(i).getGbtend() );
      out.write("</td>\r\n");
      out.write("               </tr>\r\n");
      out.write("               ");
} 
