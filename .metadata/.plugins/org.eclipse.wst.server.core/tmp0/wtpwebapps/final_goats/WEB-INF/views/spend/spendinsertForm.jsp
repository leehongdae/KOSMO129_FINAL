...
<body>
		...
		<div class="button-container">
			<button type="button" id="line12" value="결재선지정">결재선지정</button>
			<button type="button" id="sangsin1" value="상신">상신</button>
			<button  type="button" id="close" value="취소">취소</button>
		</div>
		<form id="gbtform">
		...
		<table>
			<tr>
				<th width="15%">프로젝트</th>
				<td>
					<div align="center"><span id="pro_span"></span> &nbsp; 
						<button type="button" id="projectbtn">project</button>
		...
		<table>
			...
			<tr>
				...
				<td align="center"><input type="text" size="10"
					name="gsaccount"></td>
				<!-- 거래처 -->
				<td align="center"><input type="text" size="30" name="gsinfo"></td>
				<!-- 적요 -->
