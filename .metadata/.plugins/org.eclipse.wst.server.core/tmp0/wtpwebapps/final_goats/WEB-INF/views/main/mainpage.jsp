...
//         alert("yymmdd >>> : " + yymmdd);
      ...
      $(document).ready(function () {
    	  ...
    	  $(document).on("click", "#noti_click", function(){
         ...
         if(listVa != null){
            ...
            %>  
               ...
               $("#mytable").append("<tr><td><%= svoVa.getWriter().split(" ")[1] %></td>"
                      ...
                      + "<td><%= svoVa.getGpstart().substring(0,11) %></td>"
                      + "<td><%= svoVa.getGpend().substring(0,11) %></td>"
                      + "</tr>");
         <%        
               } 
         }
				...
				<div style="display: flex; height: 65%;">
					...
					<div class="notice" style="height: auto; width: 35%;">
						<table id="noticet">
							<tr>
								<td>공지사항</td>
								<td style="text-align:right"><a id="noti_click" style="cursor: pointer;">+</a></td>
							</tr>
							<tr> 
								<td>제목</td>
								<td>작성자</td>
