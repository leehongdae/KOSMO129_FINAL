...
<body>
   ...
   <div style="margin: 0; padding: 0; width:100%;">
      ...
      <div class="alert" style="background-color: whitesmoke; height: auto">
         ...
         <span style="color: #337ab7; line-height:1; margin-left:1374px;">HOME</span><span style="line-height:1;">&nbsp;/ 휴가 / 휴가 현황</span>
          <table style="margin-left:auto; margin-right:auto; border-top:2px solid #1C1C1C; background-color : white; border-radius: 3px; width:1300px;">
         <tr>
            <th colspan="7" style="text-align:left;"><img src="/resources/goats_icon/vacation.png" width="15" height="15" style="position: relative; top:2px;">휴가 현황</th>
         </tr>
         <tr>
         <td colspan="7">
