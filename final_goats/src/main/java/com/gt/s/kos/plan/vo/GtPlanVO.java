package com.gt.s.kos.plan.vo;

public class GtPlanVO {

	public GtPlanVO() {
	}
	public GtPlanVO(String gpnum, String gpsubject, String gppnum, String writer, String gptype, String gpmemo,
